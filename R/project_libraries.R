...
packages_required_in_project <- 
  c("arm", "aspace","BaSTA","bayestestR","broom.mixed", "coefplot2", "cowplot",
    ...
    "leaflet", "lme4", "magick", "mapview", "mgcv", "moveVis", "multcomp", 
    "multipanelfigure", "parallel", "parameters", "partR2", "patchwork", 
    "RColorBrewer", "rptR", "RSQLite", "scales", "snowfall", "sp", 
    "standardize", "tidybayes", "tidyverse", "rmdformats")
